...
MATLAB_FUN = "VASTGeneration" # script that launch matlab binary
...
final_dataset_size = 10 # number of entries in the final dataset (after merged)
n_task = 0              # [init] a parameter configuration
n_jobs_per_task = 2     # number a of job for the same configuration
